...
WetspatialDir <- file.path('../../../Projects/ESI/Values/Wetlands/Assessment/Data')
...
FREPDir<-file.path('/Users/darkbabine/Sync/STC/Science and Technical Committee/Base Information/Data/FREP')
Tier2Dir<-file.path('/Users/darkbabine/Sync/Wetland/Tier 2/Data')
CGLDir<-file.path('/Users/darkbabine/Dropbox (BVRC)/Projects/LUP/Wetzinkwa/Data/CGL_Wetlands')
MooseDir<-file.path('/Users/darkbabine/Sync/Moose/Tier 2/Field Preparation and Planning/Site Selection & Planning/20-21/Sample Draw/shp')
...
WetMonDir<-file.path(SyncDir,'Wetland/Tier 2/Field Data and Results')
